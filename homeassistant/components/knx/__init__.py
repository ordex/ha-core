...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    knx_module.ui_entity_bridge_controller.start(
        hass, knx_module.xknx, knx_module.config_store.get_entity_bridges()
    )
...
async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    knx_module.ui_entity_bridge_controller.stop()
